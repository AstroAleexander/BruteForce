...
echo " ╚██████╔╝╚██████╔╝██║  ██║██████╔╝██║  ██║██║  ██║   ██║   ███████╗╚██████╗██║  ██║"
echo "  ╚══▀▀═╝  ╚═════╝ ╚═╝  ╚═╝╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝   ╚═╝   ╚══════╝ ╚═════╝╚═╝  ╚═╝"
echo "                                                    By MrAlexandeer ( Adil Hamidi ) "

echo -e "	[+]              $red Coded By MrAlexandeer#5715$nc         		   [+]"
echo -e "	[+] 		 $red www.instagram.com/mralexander_tv$nc 		   [+]"
echo -e "	[+] 		 $red www.youtube.com/MrAlexandeerTV$nc          	   [+]"
echo -e "	[+]$red Special Greetz To$nc :$green {Vexy#5266}$nc [+]"
echo ""
